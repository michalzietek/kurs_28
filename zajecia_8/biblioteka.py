...
instancja_file_handlera = FileHandler(sciezka_do_pliku_z_historia="historia.json",
                                      sciezka_do_pliku_z_ksiegozbiorem_i_saldem="ksiegozbior_i_saldo.json")
# jeden_tuple = instancja_file_handlera.odczyt_danych_z_pliku_z_ksiegozbiorem_i_saldem()
# budzet_ksiegarni = jeden_tuple[0]
# ksiegozbior = jeden_tuple[1]
budzet_ksiegarni, ksiegozbior = instancja_file_handlera.odczyt_danych_z_pliku_z_ksiegozbiorem_i_saldem()
lista_operacji = instancja_file_handlera.odczyt_danych_z_pliku_z_historia()
...
while not koniec_programu:
    ...
    if operacja == "1":
        ...
        budzet_ksiegarni += int(kwota_do_dodania)
        ...
        instancja_file_handlera.zapis_do_pliku_z_ksiegozbiorem_i_saldem(budzet=budzet_ksiegarni, ksiegozbior=ksiegozbior)